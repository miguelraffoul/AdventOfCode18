...
int getSumAfterGenerations( unordered_map<string, char>&, const string&, const int );
...
int main( void ) {
    ...
    cout << getSumAfterGenerations( rules, inital_config, 20 ) << endl;
...
int getSumAfterGenerations( unordered_map<string, char>& rules, const string& inital_config, const int generations ) {
