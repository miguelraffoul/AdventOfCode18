...
void updatePositions( vector< pair<int, int> >&, const vector< pair<int, int> >& );
...
int main( void ) {
    ...
    while( iterations-- ) {
        updatePositions( positions, speeds );
    }
...
void updatePositions( vector< pair<int, int> >& positions, const vector< pair<int, int> >& speeds ) {
